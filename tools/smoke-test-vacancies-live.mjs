...
if (legacyOnDisplay !== summary.reviewPending) {
  fail(`Expected ${summary.reviewPending} review-pending cards on display, got ${legacyOnDisplay}`);
} else {
  pass("Review-pending on display count consistent with verification state");
}
