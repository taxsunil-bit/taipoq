...
export const STUDY_COURSES = [
  ...
  },
  {
    ...
    description:
      "कम्प्यूटर, Hardware, Software, Input-Output, MS Word, Excel / Spreadsheet और परीक्षा में पूछे जाने वाले सामान्य प्रश्न।",
...
export const CB_COURSE = {
  ...
  intro:
    "कम्प्यूटर का मूलभूत ज्ञान नौकरी परीक्षाओं और दैनिक कार्यों के लिए अत्यधिक उपयोगी है। इस पाठ्यक्रम में कम्प्यूटर, Hardware, Software, Input, Output, Memory, Storage, Internet, Email, MS Word और Excel / Spreadsheet की जानकारी सरल रूप में मिलेगी।",
