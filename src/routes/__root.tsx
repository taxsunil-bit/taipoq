...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Learn, practice, and test English and Hindi typing with speed, accuracy, mistake analysis, and progress tracking." },
      { name: "author", content: "TAIPOQ" },
      { property: "og:title", content: "TAIPOQ — Smart English & Hindi Typing Tutor" },
      { property: "og:description", content: "Learn, practice, and test English and Hindi typing." },
