        ...
        <li key={subject.slug}>
          ...
          >
            ...
            <span className="mt-1 text-sm text-blue-100">
              {subject.freeCount} free · {subject.paperCount} paper{subject.paperCount === 1 ? "" : "s"}
            </span>
            {subject.hasCurrentAffairs ? (
              <span className="mt-1 text-[11px] text-amber-100/90">Date-stamped CA — refresh note</span>
            ) : null}
          </Link>
        </li>
      ))}
